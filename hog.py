...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    a = player_score % 10
    # don't assume scores are below 100
...
def take_turn(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # use dice is enough, don't need to let dice = six_sided
    # END PROBLEM 3
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    """
    # BEGIN PROBLEM 9
    cnt, score, index = 1, 0, 0
    while cnt <= 10:
        score_next = make_averaged(roll_dice, samples_count)(cnt, dice)
        if score_next > score:
            score = score_next
            index = cnt
        cnt += 1
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    diff = 100 - score
    return sus_strategy(score, opponent_score, diff, 6)
    # END PROBLEM 12
